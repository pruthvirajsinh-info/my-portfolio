...
const Landing = ({setSelectedPage}) => {
  ...
  return (
    <section id="home" className='md:flex md:justify-between md:items-center md:h-full gap-16 py-10 h-full'>
      {/* Image section */}
    <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32 ">
      ...
      <motion.div
        ...
        <p className='text-6xl font-playfair z-10 text-cent mg:text-start'>
          Raa {""}
          <span className="xs:relative xs:text-deep-blue xs:font-semibold z-20 xs:before:content-brush before:absolute before:-left-[25px] before:-top-[70px] before:z-[-1]">Pruthvi</span>
        </p>
