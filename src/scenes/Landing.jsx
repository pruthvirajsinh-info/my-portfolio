  ...
  return (
    <section id="home" className="md:flex md:justify-between md:items-center md:h-full gap-16 pt-1 my-1">
      ...
      <div className="md:order-2 flex justify-center basis-3/5 z-10 md:mt-32 ">
        {isAMdScreens ? (
        <div className="relative m-5 z-0 ml-20 before:absolute before:-top-20 before:-left-20 before:rounded-t-[400px] before:w-full before:max-w-[400px] md:before:max-w-[600px] before:h-full before:border-2 before:border-blue before:z-[-1]">
